...
public class MealTestData {
    ...
    public static final int MEAL_ALIEN_ID = START_SEQ + 10;
    public static final int MEAL_NOTFOUND = START_SEQ + 100;
    ...
    public static final Meal mealAlien = new Meal(MEAL_ALIEN_ID, LocalDateTime.of(2015, Month.JUNE, 1, 14, 0), "Админ ланч", 510);
