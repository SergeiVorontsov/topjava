...
<div class="container" style="margin-top: 30px">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header"><h2>Edit meal</h2></div>
                <div class="card-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="description" id="desc" required
                                           ...
                                           pattern="([А-Яа-яЁёA-Za-z]{1,15}\s*){1,5}"
                                           placeholder="Input only letters">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label class="col-sm-3 col-form-label" for="cal">Calories</label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="calories" id="cal" required
                                           value="${meal.calories}" pattern="^[0-9]+$"
