...
public abstract class JdbcMealRepository implements MealRepository {
    ...
    protected abstract <T> T getSupportedDateTime(LocalDateTime datetime);
    ...
    public Meal save(Meal meal, int userId) {
        MapSqlParameterSource map = new MapSqlParameterSource()
                ...
                .addValue("date_time", getSupportedDateTime(meal.getDateTime()))
    ...
    public List<Meal> getBetweenHalfOpen(LocalDateTime startDateTime, LocalDateTime endDateTime, int userId) {
        return jdbcTemplate.query(
                ...
                ROW_MAPPER, userId, getSupportedDateTime(startDateTime), getSupportedDateTime(endDateTime));
    }
}
